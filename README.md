...
![0G](https://img.shields.io/badge/Built%20for-0G%20Zero%20Cup-7C5CFC?style=for-the-badge)
...
A["Create Identity"] --> B["Chat"]
B --> C["Memory Evolves"]
C --> D["Identity Profile"]
D --> E["Clone Identity"]
D --> F["Mix Two Identities"]
E --> G["Hybrid Identity"]
F --> G
G --> H["DNA Capsule"]
H --> I["Published on 0G"]
