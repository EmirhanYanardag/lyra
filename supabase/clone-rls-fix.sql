...
drop policy if exists "LYRA clone profiles public read" on public.profiles;
...
create policy "LYRA clone profiles public read"
on public.profiles for select
to anon, authenticated
using (true);

drop policy if exists "LYRA clone agents select public" on public.agents;
drop policy if exists "LYRA clone agents select own" on public.agents;
drop policy if exists "LYRA clone agents insert own" on public.agents;
drop policy if exists "LYRA clone agents update own" on public.agents;
drop policy if exists "LYRA clone agents delete own" on public.agents;
...
create policy "LYRA clone agents select public"
on public.agents for select
to anon, authenticated
using (visibility = 'public');

create policy "LYRA clone agents select own"
on public.agents for select
to authenticated
using (owner_id = auth.uid());

create policy "LYRA clone agents insert own"
on public.agents for insert
to authenticated
with check (owner_id = auth.uid());

create policy "LYRA clone agents update own"
on public.agents for update
to authenticated
using (owner_id = auth.uid())
with check (owner_id = auth.uid());

create policy "LYRA clone agents delete own"
on public.agents for delete
to authenticated
using (owner_id = auth.uid());

drop policy if exists "LYRA clone lineage select public or own child" on public.agent_lineage;
drop policy if exists "LYRA clone lineage insert own child" on public.agent_lineage;
...
create policy "LYRA clone lineage select public or own child"
...
create policy "LYRA clone lineage insert own child"
